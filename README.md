...
Trigger the Azure DevOps pipeline to deploy the application.

💡 Key Interview Talking Points

Designed zero-downtime deployment using Blue-Green strategy

Implemented Infrastructure as Code using Terraform

Followed DevSecOps best practices

Controlled Azure costs through service management

Integrated AI concepts into DevOps workflows

Mirrors real enterprise cloud deployment patterns
